...
// Using our own types instead of importing fastify directly
...
export class SecurityService {
  ...
  private setupCors(app: FastifyInstance): void {
    ...
    // In production, use the configured whitelist
    const allowedOrigins = isProduction
      ...
      : undefined; // undefined indicates all origins are allowed in dev mode
    ...
    app.addHook(
      ...
      (request: FastifyRequest, reply: FastifyReply, done: () => void) => {
        ...
        // If we're in development or the origin is whitelisted

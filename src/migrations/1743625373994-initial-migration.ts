...
export class InitialMigration1743625373994 implements MigrationInterface {
  name = "InitialMigration1743625373994";
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TABLE "api_key" ("createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "uuid" uuid NOT NULL DEFAULT uuid_generate_v4(), "key" character varying(255) NOT NULL, "name" character varying(255) NOT NULL, "description" text, "status" "public"."api_key_status_enum" NOT NULL DEFAULT 'active', "expiresAt" TIMESTAMP, "installation_uuid" uuid NOT NULL, "createdBy" character varying(50), "metadata" jsonb NOT NULL DEFAULT '{}', "lastUsedAt" TIMESTAMP, "rateLimit" integer NOT NULL DEFAULT '300', "requestCount" integer NOT NULL DEFAULT '0', CONSTRAINT "UQ_fb080786c16de6ace7ed0b69f7d" UNIQUE ("key"), CONSTRAINT "PK_f07cf6dbb3ed3600a5511578f81" PRIMARY KEY ("uuid"))`,
    );
    await queryRunner.query(
      `CREATE TYPE "public"."api_key_installation_permission_enum" AS ENUM('READ', 'WRITE', 'ADMIN')`,
    );
    await queryRunner.query(
      `CREATE TABLE "api_key_installation" ("createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "uuid" uuid NOT NULL DEFAULT uuid_generate_v4(), "apiKeyUuid" uuid NOT NULL, "installation_uuid" uuid NOT NULL, "permission" "public"."api_key_installation_permission_enum" NOT NULL DEFAULT 'READ', "rateLimit" integer NOT NULL DEFAULT '100', "requestCount" integer NOT NULL DEFAULT '0', "lastUsedAt" TIMESTAMP, "api_key_uuid" uuid, CONSTRAINT "PK_6d6f1b679c03d9ca6b256702798" PRIMARY KEY ("uuid"))`,
    );
    await queryRunner.query(
